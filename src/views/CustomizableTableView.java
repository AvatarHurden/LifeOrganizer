...
public class CustomizableTableView<T> extends TableView<T> {
	...
	public <S> void addColumn(String name) {
		addColumn(name, null, null);
	}
	
	public <S> void addColumn(String name, Callback<T, ObservableValue<S>> property) {
		addColumn(name, property, null);
	}
	
	public <S> void addColumn(String name, Callback<T, ObservableValue<S>> property, Callback<TableColumn<T, S>, TableCell<T, S>> cellFactory) {
